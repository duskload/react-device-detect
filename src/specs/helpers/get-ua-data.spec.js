...
const commonTestUa = 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.79 Safari/537.36';

describe('Parsing useragent', () => {
    test('should set useragent with mockUserAgent', () => {
        const uaStr = 'Mozilla/5.0 (iPad; CPU OS 5_1_1 like Mac OS X) AppleWebKit/534.46 (KHTML, like Gecko) Mobile/9B206';
        mockUserAgent(uaStr)
        expect(window.navigator.userAgent).toEqual(uaStr)
    });

    test('should get device data', () => {
        const uaStr = 'Mozilla/5.0 (Linux; Android 5.1.1; Nexus 6 Build/LYZ28E) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.79 Mobile Safari/537.36';
        setUA(uaStr)
