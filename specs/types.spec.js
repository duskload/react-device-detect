...
describe("Types tests", () => {
  ...
  describe("Forming data payloads", () => {
    ...
    it("should return createBrowserPayload()", () => {
      expect(createBrowserPayload(true, browser, engine, os, ua)).toEqual({
        isBrowser: true,
    ...
    it("should return createMobilePayload()", () => {
    ...
    it("should return createSmartTVPayload()", () => {
      expect(createSmartTVPayload(true, engine, os, ua)).toEqual({
        isSmartTV: true,
        engineName: engine.name || false,
        engineVersion: engine.version,
        osName: os.name,
    ...
    it("should return createConsolePayload()", () => {
      expect(createConsolePayload(true, engine, os, ua)).toEqual({
        isConsole: true,
        engineName: engine.name || false,
        engineVersion: engine.version,
        osName: os.name,
    ...
    it("should return createWearablePayload()", () => {
      expect(createWearablePayload(true, engine, os, ua)).toEqual({
        isWearable: true,
        engineName: engine.name || false,
        engineVersion: engine.version,
        osName: os.name,
